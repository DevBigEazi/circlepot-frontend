...
const NetworkTroubleshooting: React.FC<NetworkTroubleshootingProps> = ({ onRetry, onDismiss }) => {
    return (
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 mb-4">
            <div className="flex items-start gap-3">
                <span className="text-lg">🌐</span>
                <div className="flex-1">
                    <h4 className="font-medium text-blue-800 mb-2">Network Connection Issue</h4>
                    <p className="text-sm text-blue-700 mb-3">
                        It looks like there's a network connectivity issue. This might be due to:
                    </p>
