              ...
              {title && (
                <div className="flex items-center gap-3">
                  {titleIcon && (
                    ...
                    >
                      <div style={{ color: "white" }}>{titleIcon}</div>
                      {badge > 0 && (
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            {onBack && (
              <button
                onClick={onBack}
                className="p-2 mr-2 rounded-xl transition hover:opacity-80"
              >
            ...
            <div className="flex items-center gap-3">
              <div
                className="w-10 h-10 rounded-full overflow-hidden border-2 border-white shadow-md flex items-center justify-center text-white text-lg font-bold"
