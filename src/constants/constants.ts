...
export const SUBGRAPH_API_KEY = import.meta.env.VITE_SUBGRAPH_API_KEY;
export const SUBGRAPH_HEADERS = { Authorization: `Bearer ${SUBGRAPH_API_KEY}` };

// Platform Config
export const PLATFORM_FEE_RECIPIENT = import.meta.env
  .VITE_PLATFORM_FEE_RECIPIENT; // Dedicated Platform Wallet
