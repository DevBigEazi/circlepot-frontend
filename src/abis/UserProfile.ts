export const USER_PROFILE_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "string", name: "photo", type: "string" },
    ],
    name: "ProfileUpdated",
    type: "event",
  },
  ...
  {
    inputs: [{ internalType: "string", name: "_phoneNumber", type: "string" }],
  ...
  {
    inputs: [{ internalType: "string", name: "_identifier", type: "string" }],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "bool", name: "emailIsOriginal", type: "bool" },
      { internalType: "bool", name: "phoneIsOriginal", type: "bool" },
      { internalType: "uint256", name: "lastProfileUpdate", type: "uint256" },
      { internalType: "uint256", name: "createdAt", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
